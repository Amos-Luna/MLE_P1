...
class TextPreprocessor:
    ...
    def __init__(self,
                ...
                process_stemming = True,
                process_lemmatization = True
            ):
        ...
        self.process_stemming_flag = process_stemming
        self.process_lemmatization_flag = process_lemmatization
    ...
    def preprocess_text(self, text):
        ...
        if self.process_stemming_flag:
            text = self.process_stemming(text)
        if self.process_lemmatization_flag:
            text = self.process_lemmatization(text)
        return text
